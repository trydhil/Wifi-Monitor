            ...
            <div class="login-card bg-surface-container-lowest p-xl rounded-xl border border-outline-variant/30">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-lg">
                    ...
                    <div class="grid grid-cols-1 gap-md">
                        <a href="{{ route('auth.google') }}" class="w-full border border-outline-variant flex items-center justify-center space-x-md py-md rounded-lg hover:bg-surface-container transition-colors">
                            ...
                            <span class="font-body-md text-body-md text-on-surface">Masuk dengan Google</span>
                        </a>
                    </div>
                </form>
